...
class PDCompilerImpl extends PDCompiler {
  override def getCompiler(env: Environment) = {
    val baseline = new NewBaseline(env, new com.huawei.excelsior.jet.compiler.newbaseline.platforms.PlatformConfigArm64)
    new CompilerWithNativeWrappers(env, baseline, com.huawei.excelsior.jet.compiler.wrappers.platforms.PlatformConfigArm64)
  }
}
