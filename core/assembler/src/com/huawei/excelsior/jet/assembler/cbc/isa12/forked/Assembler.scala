...
trait ForkedAssembler {
  ...
  def clsh(d: IR, l: IR, r: IR, w: AsmWidth): Unit = genCheckedBinary(Checked.Lsh, w, d, l, r)
  def crsh(d: IR, l: IR, r: IR, w: AsmWidth): Unit = genCheckedBinary(Checked.Ash, w, d, l, r)
  ...
  def cursh(d: IR, l: IR, r: IR, w: AsmWidth): Unit = genCheckedBinary(Checked.Rsh, w, d, l, r)
  ...
  def clshi(d: IR, l: IR, imm: Long, w: AsmWidth): Unit = genCheckedBinaryImm(Checked.Lsh, w, d, l, imm)
  def crshi(d: IR, l: IR, imm: Long, w: AsmWidth): Unit = genCheckedBinaryImm(Checked.Ash, w, d, l, imm)
  ...
  def curshi(d: IR, l: IR, imm: Long, w: AsmWidth): Unit = genCheckedBinaryImm(Checked.Rsh, w, d, l, imm)
